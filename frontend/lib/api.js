...
export const apiClient = {
  ...
  getSecurityThreats: () => api.get('/api/security/threats'),
  killSecurityThreatProcess: (pid) => api.post('/api/security/threats/kill', { pid }),
  deleteSecurityThreatFile: (path) => api.delete('/api/security/threats/file', { data: { path } }),
  deleteSecurityThreatPersistenceLine: (path, line) => api.delete('/api/security/threats/persistence-line', { data: { path, line } }),
  removeSecurityImmutableFlag: (path) => api.delete('/api/security/threats/immutable', { data: { path } }),
